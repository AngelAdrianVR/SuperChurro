        ...
        <div>
          ...
          <div class="flex items-center mb-4">
            <div class="flex items-center mr-3">
              <input v-model="form.movement_is_entry" id="country-option-1" type="radio" name="countries" value="1"
                class="h-4 w-4 border-gray-300 focus:ring-2 focus:ring-blue-300" aria-labelledby="country-option-1"
            ...
            <div class="flex items-center">
              <input v-model="form.movement_is_entry" id="country-option-2" type="radio" name="countries" value="0"
