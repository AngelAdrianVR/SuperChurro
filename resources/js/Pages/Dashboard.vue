      ...
      <div class="globe-container">
        <div class="globe">
          ...
          <div class="flex items-center justify-between">
            <div>
              ...
              <span class="text-green-600">Entrada a las 9:00 am.</span>
            </div>
            <SecondaryButton>Salida</SecondaryButton>
          </div>
          <div class="flex items-center justify-between">
            <div>
              <i class="fa-regular fa-clock text-lg text-yellow-600 mr-2"></i>
              <span class="text-yellow-600"
                >Entrada a las 9:20 am (Retardo).</span
              >
            </div>
            <SecondaryButton>Salida</SecondaryButton>
          </div>
          <div class="flex items-center">
            ...
            <span class="text-blue-600">Salida a las 2:05 pm.</span>
          </div>
        </div>
        <!-- ------------Permutas------------- -->
        <div class="globe">
        ...
        <div class="globe">
          ...
          <div class="flex justify-between items-center">
            <span
              ><i class="fa-regular fa-calendar-days mr-2"></i>2-Ene-2022</span
            >
            <span class="text-orange-600 font-bold"
              ><i class="fa-solid fa-hourglass-start mr-2"></i>Revisando.</span
            >
          </div>
          <div class="flex justify-between items-center">
            <span
            ...
            <span class="text-green-600 font-bold"
              ><i class="fa-solid fa-check mr-2"></i>Aprobado.</span
            >
          </div>
          <div class="flex justify-between items-center">
            <span
            ...
            <span class="text-red-600 font-bold"
              ><i class="fa-solid fa-xmark mr-2"></i>Rechazado.</span
            >
          </div>
        </div>
        <!-- -----------------Préstamos----------------- -->
