    ...
    <div class="grid grid-cols-2 gap-1">
      <div class="rounded-md border-2 border-gray-400 px-3 py-2 leading-none text-xs">
        <div class="globe-title">
          <h1>Cálculo de Vacaciones año {{ today.getFullYear() }}</h1>
        </div>
        ...
        <div class="flex flex-col space-y-2 mb-4">
          ...
          <p><strong> Días de vacaciones correspondientes: </strong>{{ days_per_year }}</p>
          <p><strong> Días de vacaciones tomados: </strong>{{ days_per_year - user.employee_properties.vacations  }}</p>
          <p><strong> Días de vacaciones restantes: </strong>{{ user.employee_properties.vacations  }}</p>
          <p><strong> Prima vacacional: </strong>${{ vacation_bonus }}</p>
