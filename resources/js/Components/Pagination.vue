...
<div v-if="pagination.meta.links.length > 3" class="overflow-x-auto flex items-center justify-between px-5 my-1 sm:px-6">
    ...
    <div>
      <nav class="isolate inline-flex -space-x-px rounded-lg" aria-label="Pagination">
        ...
        <template v-for="(link,key) in pagination.meta.links">
            <div :key="key" v-if="link.url == null" class="rounded-lg relative inline-flex items-center border border-gray-300 bg-gray-200 px-2 py-1 text-sm font-medium text-gray-600 hover:bg-gray-50 focus:z-20 " v-html="link.label">
            ...
            :class="link.active ? 'z-10 bg-gray-100 border-2 border-gray-600 text-gray-600 font-bold' : 'bg-gray-200 border-gray-400 text-black hover:bg-gray-200 hover:border-gray-600'"
            />
