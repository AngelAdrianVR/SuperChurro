<template>
    <div class="globe-container">
        <div v-for="payroll in payroll.data." :key="payroll.id" @click="payroll_selected = payroll"
            ...
            <div v-if="!payroll.is_active" class="grid grid-cols-3 gap-2 text-sm">
                ...
                <span>+<i class="text-green-700 fa-regular fa-dollar-sign mr-1"></i>{{ payroll.commissions }}
                    comisiones</span>
                <span v-if="payroll.salary_for_extras">+<i class="text-green-700 fa-regular fa-dollar-sign mr-1"></i>{{
                    payroll.salary_for_extras
                }}
                    tiempo extra</span>
